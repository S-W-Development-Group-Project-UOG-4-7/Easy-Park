      ...
      <div className="surface-card relative overflow-hidden rounded-3xl p-8 shadow-2xl">
        ...
        <div className="relative space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex h-24 w-24 items-center justify-center rounded-full bg-linear-to-br from-lime-400 via-lime-500 to-lime-200 text-4xl font-bold text-slate-950" style={{ boxShadow: '0 10px 40px rgba(132, 204, 22, 0.35)' }}>
          ...
          {isEditing && (
            <div className="flex justify-end gap-3 pt-4">
              ...
              <button
                onClick={handleSave}
                className="flex items-center gap-2 rounded-xl bg-linear-to-r from-lime-500 to-lime-400 px-6 py-3 text-sm font-semibold text-slate-900 transition duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-lime-500/30"
              >
                Save Changes
              </button>
            </div>

      ...
      <main className="flex-1 ml-64 bg-gradient-to-b from-[#0F172A] to-[#020617] min-h-screen p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-[#E5E7EB]">Welcome Back, John!</h1>
              <p className="text-[#94A3B8] mt-1">Here's what's happening with your parking lot today.</p>
            </div>
            
            {/* Date Picker */}
            <div className="flex items-center gap-3 bg-gradient-to-br from-[#1E293B] to-[#0F172A] border border-white/10 rounded-xl px-4 py-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {stats.map((stat, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border border-white/10 p-6 hover:border-[#84CC16]/30 transition-all duration-300"
                >
                  ...
                  <p className="text-4xl font-bold text-[#E5E7EB]">{stat.value}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Recent Bookings */}
            <div className="lg:col-span-2 rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border border-white/10 p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-[#84CC16]">
                  Bookings for {new Date(selectedDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                </h2>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="bg-[#0F172A] border border-white/10 rounded-lg px-4 py-2 text-[#E5E7EB] text-sm focus:outline-none focus:border-[#84CC16] cursor-pointer"
                  >
            ...
            <div className="rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] border border-white/10 p-6">
              <h2 className="text-xl font-semibold text-[#84CC16] mb-6">Quick Stats</h2>
